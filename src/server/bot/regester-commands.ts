...
const commands = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        name: 'time',
        description: 'When should the RP start. Accepts Unix Timestamps and relative time. Relative: days:hours:minutes (Ex. 1:12:30 = 1 day, 12 hours, 30 minutes) or just minutes (Ex. 90 = 90 minutes)',
        type: 3, // https://discord.com/developers/docs/interactions/application-commands#application-command-object-application-command-option-type
        required: true,
      },
      {
