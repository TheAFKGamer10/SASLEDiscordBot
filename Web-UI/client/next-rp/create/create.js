...
async function createpageloaded() {
    ...
    fetch(URL + `/v1/bot/rp/create/fields`, {
        method: 'GET',
        headers: {
        ...
        .then(async data => {
            ...
            Object.keys(data).forEach((key) => {
                ...
                if (data[key].type === 'dropdown') {
                    ...
                    element.className = 'input createinput createdropdown';
                    ...
                    element.className = 'input createinput createcheckbox';
                    element.id = `input_${key}`;
                    ...
                    input.className = 'input createinput';
